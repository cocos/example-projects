module.exports = {
  "example_case_native": "该测试用例只支持移动平台",
  "example_case_native_desktop_tips": "该测试用例不支持 Mac 平台和 Windows 平台",
  "example_case_runtime_tips": "该测试用例不支持 Runtime 平台",
  "example_case_support_webGl_tips": "该测试用例只支持 WebGL 模式",
  "example_case_support_native_android_tips": "该测试用例只支持 Android 移动平台",
