    ...
    onLoad: function () {
        ...
        cc.eventManager.addListener({
            ...
            onTouchMoved: function(touch, event) {
                var touchLoc = touch.getLocation();
                self.touchLocationDisplay.string = i18n.t("cases/03_gameplay/01_player_control/EventManager/SpriteFollowTouch.js.1") + Math.floor(touchLoc.x) + ', ' + Math.floor(touchLoc.y) + ')';
                self.moveToPos = self.follower.parent.convertToNodeSpaceAR(touchLoc);
            },
